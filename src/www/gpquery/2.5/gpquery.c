...
/***** PRINT COUPLE0 ROWS OF CHILDREN *****/
	...
	case 4: /* COMPLETE PEDIGREE */
		...
		if (found)
		{
		  ...
		  printf("<TH BGCOLOR=white WIDTH=10%%>&nbsp;</TH>");
		  printf("<TD BGCOLOR=white>");
			  printf("<P ALIGN=JUSTIFY>%s<FONT COLOR=black>You can now add new children to couples in the ",TIMES_10);
			  ...
			  printf("of your pedigree above. Please indicate how many children each couple listed below has:\n</FONT></FONT></P>");
			  printf("%s<FONT COLOR=black><P ALIGN=JUSTIFY>",TIMES_10);
